...
contains
    subroutine get_derivs(n, n_ghost, x, m, h, rho, pre, cs, a, v,u, dt_new,problem,fixes)
    ...
    subroutine step(x, v, a, m, h, rho, pre, cs, dt, n, n_ghost,nmax,u,problem,fixes)
        ...
        v_half = v + dt*a0
        call get_derivs(n, n_ghost, x, m, h, rho, pre, cs, a, v_half, u,dt_new,problem,fixes)

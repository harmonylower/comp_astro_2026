...
contains
    subroutine get_derivs(n, n_ghost, x, m, h, rho, pre, cs, a, v,u, dt_new, dx, xmax,xmin)
        integer, intent(in) :: n
    ...
    subroutine step(x, v, a, m, h, rho, pre, cs, dt, n, n_ghost,nmax,u,dx,xmax,xmin)
        ...
        v_half = v + dt*a0
        call get_derivs(n, n_ghost, x, m, h, rho, pre, cs, a, v_half, u, dt_new, dx, xmax,xmin)
